...
const ProductsPage = () => {
    ...
    return (
        <div className="container mx-auto pb-5">
            ...
            {/* Loading Indicator */}
            {isLoading ? (<Loading />) : currentProducts?.length === 0 ? (
                            ...
                            {currentProducts?.map((product, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        ...
                                        <button className="text-red-600 hover:text-red-800 px-2" onClick={() => setDeleteModal(product)}>
            ...
            {openModal && <ViewProduct product={openModal} onClose={() => setOpenModal(null)} />}
        </div>
    );
};
