...
const LearnMore = () => {
    ...
    return (
        <>
            <Header />
            <div className="w-full bg-gray-50 text-gray-800 py-20 px-6 pt-28">
                <div className="container mx-auto flex flex-col items-center">
                    {/* Introduction */}
                    <div className="">
                        <h1 className="text-center text-4xl font-extrabold mb-6">
                            Learn More About Grocer Go
                        </h1>
                        <div className="text-base font-mono mb-8 space-y-1 text-gray-600">
                            <p>- Our platform is designed to empower businesses of all sizes to establish and grow their online presence.</p>
                            <p>Learn about the features, benefits, and tools we provide to help you succeed in the digital marketplace.</p>
                            <p>Benefit from our user-friendly interface, robust analytics, and seamless integration with popular payment gateways.</p>
                            <p>Build your brand with customizable templates and advanced marketing tools tailored to your needs.</p>
                        </div>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: "Manage your online store with ease using our all-in-one dashboard. From adding new products to tracking sales and monitoring customer behavior, our intuitive tools give you complete control over your eCommerce business.",
                                image: "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f",
                                alt: "Store Management",
                            },
                            {
                                title: "Powerful Marketing Tools",
                                description: "Reach your audience effectively with built-in marketing tools. Our platform supports email campaigns, SEO optimization, social media integrations, and discounts or promotions to boost your visibility and sales.",
                                image: "https://images.unsplash.com/photo-1505678261036-a3fcc5e884ee",
                                alt: "Marketing Tools",
                            },
                            {
                                title: "Secure Payment Gateways",
                                description: "We prioritize the security of your transactions. Our platform integrates with trusted payment gateways like Stripe, PayPal, and more, ensuring safe and seamless payment processing for your customers.",
                                image: "https://images.unsplash.com/photo-1563013544-824ae1b704d3",
                                alt: "Secure Payment",
                            },
                            {
                                title: "Mobile-Friendly Design",
                                description: "In today’s mobile-first world, we ensure your online store is fully responsive and optimized for all devices. Deliver a seamless shopping experience to your customers, whether they’re browsing on a desktop, tablet, or smartphone.",
                                image: "https://images.unsplash.com/photo-1517292987719-0369a794ec0f",
                                alt: "Mobile Design",
                            },
                            {
                                title: "Analytics and Insights",
                                description: "Make data-driven decisions with detailed analytics and reports. Our platform provides insights into customer behavior, sales trends, and performance metrics to help you refine your strategies and grow your business.",
                                image: "https://images.unsplash.com/photo-1532074205216-d0e1f4b6da64",
