        ...
        if (response?.product.category) {
          ...
          setSimilarProducts(
            similarProducts?.products?.filter(
              (p) => p._id !== response.product._id
            )
          );
        }
        if (response?.product._id) {
          await fetchProductRatings(response?.product._id);
        }
      } catch (error) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="relative aspect-square rounded-xl overflow-hidden bg-gray-100">
                <img
                  src={`${import.meta.env.VITE_BACKEND_URL}${
                    productDetails.ProductImages?.[activeImageIndex] ||
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() =>
                    navigate(`/user/payment/${productDetails._id}`)
                  }
                  disabled={productDetails.stock === 0}
                  className={`flex-1 py-3 px-8 rounded-lg flex items-center justify-center space-x-2 ${
                    productDetails.stock === 0
                ...
                <button
                  ...
                  className="flex-1 py-3 px-8 rounded-lg flex items-center justify-center space-x-2 border border-gray-300 hover:bg-gray-50 transition"
                >
                ...
                <button
                  ...
                  className="py-3 px-8 rounded-lg flex items-center justify-center space-x-2 border border-gray-300 hover:bg-gray-50 transition"
                >
              ...
              <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div className="grid gap-4">
                  ...
                  <div className="flex items-center space-x-3">
                    <ShieldBan className="w-5 h-5 text-blue-500" />
            ...
            <div className="relative">
              ...
              <div className="items-center gap-2 flex ">
                <div className="flex items-center mt-5">
                  {[1, 2, 3, 4, 5].map((star) => {
                    const averageRating =
                      productRating.reduce((sum, obj) => sum + obj.rating, 0) /
                    ...
                    return (
                      ...
                      >
                        ...
                        {isFull && (
                          <Star className="absolute inset-0 w-5 h-5 text-yellow-400 fill-current" />
                        )}
                        {isHalf && (
                          <Star
                ...
                <span className="mt-5 text-yellow-400 text-2xl font-bold">
                  {productRating.reduce((sum, obj) => sum + obj.rating, 0) /
                    productRating.length || 0}
                </span>
                <span className="mt-5 text-sm">
                  ( {productRating.length} reviews )
                </span>
              </div>
            </div>
            <div className="items-center">
              <button
                className="bg-blue-400 text-white rounded-lg px-4 py-2 border border-blue-700 hover:bg-blue-500"
            ...
            <div className=" ">
              {productRating && productRating.length > 0 ? (
                productRating.map((review) => (
                  <div
                    key={review._id}
                    className="flex items-start space-x-4 py-4 border border-gray-200 p-8 rounded-lg mb-4"
                  >
                    <img
                      src={
                        review.user?.profielePic
                          ? `${import.meta.env.VITE_BACKEND_URL}${
                              review.user.profielePic
                            }`
                          : "/images/usernull.png"
                      }
                      alt={review.user?.name.toUpperCase() || "User"}
                    ...
                    <div className="flex-1">
                      <div className="flex flex-row justify-between items-center">
                        <div>
                          ...
                          <p className="text-[11px] text-gray-500 mt-[-5px]">
                            Posted on :{" "}
                        ...
                        <div className="flex flex-col justify-center">
                          <span className="text-yellow-400 text-center font-bold text-3xl">
            ...
            <div className="mt-8">
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {similarProducts.map((product) => (
                  <div
                    key={product._id}
                    className="bg-white rounded-lg overflow-hidden shadow-lg transition p-4"
                  >
                    <div className="w-full h-60 overflow-hidden rounded-lg">
                      <img
                        ...
                        className="w-full h-60 object-cover cursor-pointer transform hover:scale-105 transition"
                      />
                    </div>
                    <div className="p-4">
                      ...
                      {/* <button
                        ...
                        className="mt-4 w-full py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition"
                      >
                        View Details
                      </button> */}
                    </div>
