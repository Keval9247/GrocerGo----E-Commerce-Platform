                ...
                <aside className="w-full md:w-64 bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="text-sm text-gray-600 mt-1">
                            Up to ${Math.max(...products.map(product => product.ProductPrice))}
                        </div>
                    </div>
                </aside>
                            ...
                            >
                                <div className="relative">
                                    ...
                                    {showQuickView === index && (
                                        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                                            <button className="bg-white text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-100" onClick={() => navigate(`/user/products/${product._id}`)}>
                                                Quick View
                                            </button>
                                        </div>
                                    )}
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors" onClick={handleAddtoCart}>
                                            Add to Cart
                                        </button>
                                    </div>
                                </div>
